...
<div class="hero" style="margin-bottom:2rem">
  <p class="prompt">$ ls posts/concepts/</p>
  <h1>Concepts</h1>
  <p style="color:var(--dim)">Architecture, best practices, mental models, and patterns.</p>
</div>

<h2 class="section-title">posts</h2>

{% assign cat_posts = site.posts | where: "categories", "concepts" %}
<ul class="post-list">
