...
That is the idea behind [IGTS - Identity Governance Tagging Standard]({itgs-link}): make governance meaning explicit at the source, then let IGA parse, validate, and govern it.
...
- [IGTS - Identity Governance Tagging Standard]({itgs-link}) - source-side governance metadata